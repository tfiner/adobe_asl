...
void provider_skip_bytes(void*       info,
                         std::size_t count)
{
    ...
    view_m(view)
{
    ...
    ::CGDataProviderCallbacks cg_callbacks;

    cg_callbacks.getBytes = &provider_get_bytes;
    cg_callbacks.skipBytes = &provider_skip_bytes;
    cg_callbacks.rewind = &provider_rewind_bytes;
    cg_callbacks.releaseProvider = NULL;

    provider_m.reset(::CGDataProviderCreate(this, &cg_callbacks));
