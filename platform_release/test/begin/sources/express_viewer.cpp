...
bool application_t::_initialize()
{
    ...
    //
    adobe::file_slurp<char>     glossary_slurp(adobe::find_resource(boost::filesystem::path("glossary.xstr", boost::filesystem::native)));
    ...
    //
    bfs::path editor_adm(adobe::find_resource(boost::filesystem::path("editor.adm", boost::filesystem::native)));
    bfs::path editor_eve(adobe::find_resource(boost::filesystem::path("editor.eve", boost::filesystem::native)));
...
void application_t::_sheet_ops( adobe::name_t name, const adobe::any_regular_t& value )
{
             ...
             name == editor_action_ls_set)
    {
        ...
        else if (name == editor_action_ls_inspect)
        {
            ...
            stream << adobe::begin_asl_cel << _holder_m->top_client_holder().layout_sheet_m.get(adobe::name_t(ls_cell.c_str())) << adobe::end_asl_cel;
